...
<body class="u-body u-xl-mode" data-lang="es">
    ...
    <section class="u-align-center u-clearfix u-gradient u-section-1" id="sec-3298">
        <div class="u-align-left u-clearfix u-sheet u-valign-top-sm u-sheet-1">
            ...
            <div class="u-expanded-width u-table u-table-responsive u-table-1" style="text-align: center">
                <div class="row">
                    <div class="col-md-4">
                        <?php $id_p = $_GET['id_p']; ?>
                        <a href="Formulario_evento.php?id_p=<?php echo $id_p; ?>" type=""
                            class="u-btn u-btn-submit u-button-style">
                            Crear </a>
            ...
            <tbody class="u-table-body">
                ...
                <?php
                $con = "SELECT * from eventos WHERE id_docente='$id_p'";
                                    ...
                                    <div class="u-clearfix u-sheet u-sheet-1">
                                        ...
                                        <div class="u-expanded-width u-table u-table-responsive u-table-1"
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <?php $id_p = $_GET['id_p']; ?>
                                                    <a href="../screens/Formulario_editar_evento_d.php?id_p=<?php echo $id_p; ?>
                                                    &titulo=<?php echo $most['titulo']; ?>
                                                    &descripcion=<?php echo $most['descripcion']; ?>
                                                    &imagen=<?php echo $most['imagen']; ?>
                                                    &id=<?php echo $most['ID']; ?>" type=""
                                                        class="u-btn u-btn-submit u-button-style">
                                                        Editar </a>
                                                    <a href="../php/Eliminar_evento.php?id_p=<?php echo $id_p; ?>&id=<?php echo $most['ID']; ?>"
                                                        type="" class="u-btn u-btn-submit u-button-style">
                                                        Eliminar </a>
                                                </div>
                                            </div>
                                        </div>
