...
<body class="u-body u-xl-mode" data-lang="es">
  ...
  <section class="u-clearfix u-gradient u-section-1" id="sec-bb3b">
    <div class="u-clearfix u-sheet u-sheet-1">
      <h1 class="u-text u-text-default u-text-white u-text-1">Edicion de Evento </h1>
      <div class="u-form u-form-1">
        ...
        <form action="../php/Editar_evento.php?id_p=<?php echo $id_p; ?>
        &id=<?php echo $id; ?>
        &imagen_old=<?php echo $imagen; ?>" method="POST" enctype="multipart/form-data">
        ...
        class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required=""><?php echo $descripcion;?></textarea>
